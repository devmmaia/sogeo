...
class APITests(APITestCase):
    ...
    def setUp(self):
        ...
        """
        self.user1 = User.objects.create_user(username='johnlennon', password='aA12#$sd', about="Imagine" )
        self.user2 = User.objects.create_user(username='howardlevy', password='aA12#$sd' )
